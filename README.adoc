= Antora UI CIM Users Group Specification
// Settings:
:experimental:
:hide-uri-scheme:
// Project URLs:
...
:link-license: https://www.mozilla.org/en-US/MPL/2.0/[Mozilla Public License Version 2.0] (MPL-2.0).
...
This project is a fork of the official {url-antora}[Antora Default UI]. In adherence with its license, this project
will also be licensed under {link-license}.

Most of the remainder of this README is a copy of the instructions from the default UI project.
...
Copyright (C) 2026-present CIM Users Group.
